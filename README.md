...
**Name:** Mateusz Bielówka  
**Education:** Third-year student of Computer Science and Intelligent Systems at AGH in Krakow  
**Passions:** Programming, Mathematics  
**Skills:** C, C++, Java, Python, HTML, React  
**Experience:** Web development, simulation modeling, IoT device design, AI-powered prediction
...
- IoT: Hardware Design, Sensor Integration  
- AI/ML: Machine Learning Pipelines, Generative AI as a Service  
- Cloud Deployment: Docker, Microservices Architecture  

---

## Contact  
**Email:** mateusz.bielowka@agh.edu.pl  
**LinkedIn:** [Mateusz Bielówka](https://www.linkedin.com/in/mateusz-biel%C3%B3wka-2888b5366/)

---

**License:** This portfolio is licensed under a Creative Commons Attribution-ShareAlike 4.0 International License.  
